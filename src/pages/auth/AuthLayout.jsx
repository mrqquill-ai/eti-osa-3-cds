...
function MobileTopBar() {
  return (
    <div
      className="lg:hidden flex items-center gap-3 px-5 py-4 flex-shrink-0"
      style={{ backgroundColor: G }}
    >
      <div
      ...
      <div>
        <div className="text-white font-bold text-sm leading-tight">Eti-Osa 3 Special CDS</div>
        <div className="text-[11px] leading-tight" style={{ color: 'rgba(255,255,255,0.5)' }}>
          Clearance Queue System
        </div>
      </div>
    </div>
  )
